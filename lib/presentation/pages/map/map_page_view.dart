    ...
    body: Stack(
      children: [
        _MapCanvas(
          ...
          cesenaBounds: _cesenaBounds,
          isMapLocked: _isMapLocked,
          currentRotation: _currentRotation,
          onRotationChanged: (rotation) => setState(() => _currentRotation = rotation),
      ...
      children: [
        ...
        if (data.isTourActive && _tourController.status == TourStatus.running)
          Positioned(
            ...
            child: ManualArrivalButton(onTap: _tourController.markArrivedManually),
          ),
        if (data.isTourActive)
          Positioned(
            left: 16,
    ...
    return FlutterMap(
      ...
      children: [
        TileLayer(
          ...
          subdomains:
              selectedMapStyle == MapStyle.offline ? const [] : const ['a', 'b', 'c', 'd'],
          userAgentPackageName: 'com.geoapp.prototype',
          maxZoom: 19,
          tileBounds: cesenaBounds,
          tileProvider: selectedMapStyle == MapStyle.offline ? localTileProvider : null,
        ),
        if (canUseLocation)
