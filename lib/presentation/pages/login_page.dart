...
class _LoginPageState extends State<LoginPage>
  ...
  Future<void> _handleSignIn() async {
    ...
    try {
      ...
      setState(
        () => _error =
            AppLocalizations.of(context)!.loginFailedCheckConnection,
      );
    } finally {
  ...
  String _mapAuthErrorMessage(FirebaseAuthException exception) {
    switch (exception.code) {
      case 'network-request-failed':
        return AppLocalizations.of(context)!.offlineCheckInternet;
      default:
        return AppLocalizations.of(context)!.loginFailedRetry;
    }
  }
